...
void static event_garage_door_button(lv_event_t * e)
{
    ...
    switch(code)
    {
        case LV_EVENT_PRESSED:
            mqttClient.publish(SECRETS::MqttTopicButtonsPressed, "garage_button_pressed");
        break;

        case LV_EVENT_CLICKED:
            mqttClient.publish(SECRETS::MqttTopicButtonsPressed, "garage_button_clicked");
        break;

        case LV_EVENT_LONG_PRESSED:
            mqttClient.publish(SECRETS::MqttTopicButtonsPressed, "garage_button_long_pressed");
        break;

        case LV_EVENT_LONG_PRESSED_REPEAT:
            mqttClient.publish(SECRETS::MqttTopicButtonsPressed, "garage_button_long_pressed_repeat");
        break;
